...
/***** Function Prototypes *****/
/**
 * @brief      Initializing the I2C Master Interface
 *             Print error message if initialization fails
*/
void i2c_init(void);
/**
 * @brief      Scan for I2C slave devices on the bus
 * 	       Create an I2C request structure for the scan
 * 	       Setup the I2C frequency
*/
void i2c_scan(void);
/**
 * @brief      Write data to a specific register of an I2C slave device.
 * @param      address	     Address of the slave device.
 * @param      reg_adress    Address of the register which writing will be done.
 * @param      data	     Pointer to the data to be written to the register address.
 ...
 * @param      address	     Address of the slave device.
 * @param      reg_adress    Address of the register from which reading will be done.
 * @param      buffer	     Pointer to the buffer to where the data is read.
 * @param      length	     Length of the buffer to be read.
 * @return     return 0, If function is successful.
*/
